/* 
    - recuperar data de json
    - imprimir los posters creando los nodos
    - actualizar funciones con arrow functions
    - sacar el onclick del html de seleccion_pelis

    Versión 1 funciona:
    - se imprimen todos los posters en posters que tiene d-none
    - al hacer click en todas las pelis, se saca el d-none de posters
    - al hacer click en random pelis:
        - se borra contenido resultado_random
        - se ocultan todas las pelis
        - se saca d-none a random peliculas
        - genera 3 números aleatorios
        - buscar en el array de posters esos 3 numeros
        - imprime los 3 resultados en resultado_random

    Versión 2: 
    - event listener en todas las pelis. al hacer click se recupera el json con los posters y se imprimen todos. también ocultar random_pelis
    - event listener en random pelis. funciona de la misma manera que version 1
    - tener una función separada que imprima desde posters.json ya que se usa dos veces
