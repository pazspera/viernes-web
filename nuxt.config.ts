  ...
  app: {
    head: {
      link: [
        ...
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Cardo:wght@700&family=Karla:wght@300;400;700&family=Major+Mono+Display&family=Outfit:wght@400;700&display=swap'}
      ]
    }
  },
